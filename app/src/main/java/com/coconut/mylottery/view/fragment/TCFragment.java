...
public class TCFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fcListView = new ListView(this.getActivity());
    ...
    private void changeNotice(CurrentIssueElement issueElement) {
        ...
        switch (lotteryID) {
            case ConstantValue.LOTTERYID_SSQ:
                ...
                textView = (TextView) fcListView.findViewWithTag(0);
                if (textView != null) {
            ...
            case ConstantValue.LOTTERYID_3D:
                ...
                textView = (TextView) fcListView.findViewWithTag(1);
                if (textView != null) {
                    textView.setText(resultInfo);
                    //ssqIssue.setText(resultInfo);
                }
            ...
            case ConstantValue.LOTTERYID_7LC:
                ...
                textView = (TextView) fcListView.findViewWithTag(2);
                if (textView != null) {
                    textView.setText(resultInfo);
                    //ssqIssue.setText(resultInfo);
                }
