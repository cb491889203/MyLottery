 ...
 */
public class LotteryListFragment2 extends ListFragment {
    ...
    class LotteryFragementAdapter extends BaseAdapter {
        ...
        // 资源信息
        private int[] logoResIds = new int[]{R.drawable.id_k3, R.drawable.id_11x5, R.drawable.id_kl8};

        private int[] titleResIds = new int[]{R.string.is_hall_k3_title, R.string.is_hall_11x5_title, R
                .string.is_hall_k18_title};
